...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoidGswMzU4IiwiYSI6ImNrZHY3NjhoMzJnNHMyeW1oaWJ6N3dyZXcifQ.0kHLmOIOtUa6B-YCOL7C-Q';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/tk0358/ckdv84ysy0lcm19mohlfqzj4i',
    scrollZoom: false // center: [-118.1, 34.117],
    // zoom: 10,
    // interactive: false,
...
var stripe = Stripe('pk_test_51HNPEDAWRC6UJfx6eNQZmdMdPsjp76D3nCgmwXu155cC6lvNW9syWdN3trGoP2PosYlyTz8ytJlsh6FKDGsWEK4500ApHAu67P');

var bookTour = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(tourId, startDate) {
    var session;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return (0, _axios.default)("http://127.0.0.1:3000/api/v1/bookings/checkout-session/".concat(tourId, "/").concat(startDate));
...
exports.deleteReviewAtMyReviews = exports.addEventsToDeleteReviewBtns = exports.addEventsToEditReviewBtns = exports.createReviewFromAdmin = exports.sortReview = exports.updateReview = exports.createReview = void 0;
...
var createReview = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(rating, review, user, tour) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
...
var updateReview = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(reviewId, rating, review) {
    var res;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Thank you for updating a review!');
  ...
  return function updateReview(_x5, _x6, _x7) {
    return _ref2.apply(this, arguments);
  };
}();
...
var sortReview = /*#__PURE__*/function () {
...
var createReviewFromAdmin = /*#__PURE__*/function () {
  ...
  return function createReviewFromAdmin(_x9) {
    return _ref4.apply(this, arguments);
  };
}();
...
var deleteReviewAtMyReviews = /*#__PURE__*/function () {
  var _ref8 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee8(reviewId) {
    var result, res;
    return regeneratorRuntime.wrap(function _callee8$(_context8) {
      while (1) {
        switch (_context8.prev = _context8.next) {
          case 0:
            _context8.prev = 0;
            result = window.confirm('CONFIRM: Do you delete this review?');
  ...
  return function deleteReviewAtMyReviews(_x14) {
    return _ref8.apply(this, arguments);
  };
}();

exports.deleteReviewAtMyReviews = deleteReviewAtMyReviews;
...
var createLike = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(user, tour) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
  ...
  return function createLike(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();
...
var deleteLike = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(like) {
    var res;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'DELETE',
              url: "http://127.0.0.1:3000/api/v1/likes/".concat(like)
            });
  ...
  return function deleteLike(_x3) {
    return _ref2.apply(this, arguments);
  };
}();
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'New tour is created successfully!');
              window.setTimeout(function () {
...
var updateTour = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(data, tourId) {
    var res;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Tour is updated successfully!');
              window.setTimeout(function () {
                location.assign('/manage/tours');
              }, 1500);
            }
...
var deleteTour = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(tourId) {
    var res;
    return regeneratorRuntime.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 3:
            ...
            if (res.status === 204) {
              (0, _alerts.showAlert)('success', 'This tour is deleted successfully!');
              window.setTimeout(function () {
                location.reload(true);
              }, 1500);
            }
  ...
  return function deleteTour(_x4) {
    return _ref3.apply(this, arguments);
  };
}();
...
exports.createUser = exports.deleteUser = exports.updateUser = void 0;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'User is updated successfully!');
              window.setTimeout(function () {
                location.reload(true);
              }, 1500);
            }
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'New user is created successfully!');
              window.setTimeout(function () {
...
var bookBtns = document.querySelectorAll('.book-tour');
var reviewForm = document.querySelector('.review-form');
var heartBtn = document.getElementById('heart');
var reviewEditForm = document.getElementById('review-edit-form');
var addDateBtn = document.getElementById('add-date-button');
var deleteDateBtn = document.getElementById('delete-date-button');
var addLocBtn = document.getElementById('add-loc-button');
var deleteLocBtn = document.getElementById('delete-loc-button');
var updateTourForm = document.getElementById('form--edit-tour');
var createTourForm = document.getElementById('form--create-tour');
var deleteTourBtns = document.querySelectorAll('.btn--delete-tour');
var selectBoxDifficultyEdit = document.querySelector('.selectbox--difficulty-edit');
var editUserBtns = document.querySelectorAll('.btn--edit-user');
...
var createBookingForm = document.getElementById('form--create-booking'); // delete buttons at my reviews page

var deleteReviewBtnsAtMyReviews = document.querySelectorAll('.delete-review'); // DELEGATION
...
if (bookBtns) _toConsumableArray(bookBtns).forEach(function (el) {
  return el.addEventListener('click', /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(e) {
      var _e$target$dataset, tourId, startDate;
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              _e$target$dataset = e.target.dataset, tourId = _e$target$dataset.tourId, startDate = _e$target$dataset.startDate;
              _context2.next = 4;
              return (0, _stripe.bookTour)(tourId, startDate);
...
if (reviewForm) reviewForm.addEventListener('submit', function (e) {
  e.preventDefault();
  var rating = reviewForm.star.value;
  var review = document.getElementById('review-text').value;
  var user = document.getElementById('review-user').dataset.userId;
  var tour = document.getElementById('review-user').dataset.tourId;
  console.log(rating, review, user, tour);
  (0, _review.createReview)(rating, review, user, tour);
});
if (heartBtn) heartBtn.addEventListener('click', function (e) {
  // e.preventDefault();
  var user = heartBtn.dataset.userId;
  var tour = heartBtn.dataset.tourId;
  var like = heartBtn.dataset.likeId;

  if (heartBtn.classList.contains('active')) {
    heartBtn.classList.remove('active');
    (0, _like.deleteLike)(like);
  } else {
    heartBtn.classList.add('active');
    (0, _like.createLike)(user, tour);
  }
});
if (reviewEditForm) reviewEditForm.addEventListener('submit', function (e) {
  e.preventDefault();
  var reviewId = reviewEditForm.dataset.reviewId;
  var rating = reviewEditForm.star.value;
  var review = document.getElementById('reviwe-edit').value;
  (0, _review.updateReview)(reviewId, rating, review);
}); // button to add input fields for startDate

if (addDateBtn) addDateBtn.addEventListener('click', function (e) {
  e.preventDefault();
  var formStartDates = document.getElementById('form__startDates');
  var count = formStartDates.childElementCount; // console.log(count);

  var el = "\n      <div class=\"form__group form__group-startDate\">\n        <label class=\"form__label\" for=\"startDate".concat(count, "\">startDate").concat(count + 1, "</label>\n        <label class=\"form__label-small\" for=\"startDate").concat(count, "\">startDate</label>\n        <input class=\"form__input\" id=\"startDate").concat(count, "\" type=\"text\">\n        <label class=\"form__label-small\" for=\"participant").concat(count, "\">participant</label>\n        <input class=\"form__input\" id=\"participant").concat(count, "\" type=\"text\">\n        <label class=\"form__label-small\" for=\"soldOut").concat(count, "\">soldOut</label>\n        <select class=\"form__input\" id=\"soldOut").concat(count, "\">\n          <option value=\"true\">true</option>\n          <option value=\"false\" selected>false</option>\n        </select>\n      </div>\n    ");
...
if (deleteDateBtn) deleteDateBtn.addEventListener('click', function (e) {
  e.preventDefault();
  var startDateGroups = document.getElementsByClassName('form__group-startDate'); // console.log(startDateGroups);

  var formStartDates = document.getElementById('form__startDates');
  formStartDates.removeChild(startDateGroups[startDateGroups.length - 1]);
  var count = formStartDates.childElementCount;
...
if (addLocBtn) addLocBtn.addEventListener('click', function (e) {
  e.preventDefault();
  var formlocations = document.getElementById('form__locations');
  var count = formlocations.childElementCount; // console.log(count);

  var el = "\n      <div class=\"form__group form__group-location\">\n        <label class=\"form__label\" for=\"coordinates-ew-".concat(count, "\">locations").concat(count + 1, "</label>\n        <label class=\"form__label-small\" for=\"coordinates-ew-").concat(count, "\">coordinates(east+/west-)</label>\n        <input class=\"form__input\" id=\"coordinates-ew-").concat(count, "\" type=\"text\">\n        <label class=\"form__label-small\" for=\"coordinates-ns-").concat(count, "\">coordinates(north+/south-)</label>\n        <input class=\"form__input\" id=\"coordinates-ns-").concat(count, "\" type=\"text\">\n        <label class=\"form__label-small\" for=\"description").concat(count, "\">description</label>\n        <input class=\"form__input\" id=\"description").concat(count, "\" type=\"text\">\n        <label class=\"form__label-small\" for=\"day").concat(count, "\">day</label>\n        <input class=\"form__input\" id=\"day").concat(count, "\" type=\"text\">\n      </div>\n    ");
...
if (deleteLocBtn) deleteLocBtn.addEventListener('click', function (e) {
  e.preventDefault();
  var formlocations = document.getElementById('form__locations');
  var locationGroups = document.getElementsByClassName('form__group-location');
  formlocations.removeChild(locationGroups[locationGroups.length - 1]);
  var count = formlocations.childElementCount;
...
var appendFormInfo = function appendFormInfo(form, type) {
  ...
  document.querySelectorAll('.form__group-startDate').forEach(function (el, i) {
    ...
    form.append("startDates[".concat(i, "][soldOut]"), el.children[6].value);
  });
  form.append('startLocation[coordinates][0]', document.getElementById('startloc-ew').value);
  form.append('startLocation[coordinates][1]', document.getElementById('startloc-ns').value);
  form.append('startLocation[address]', document.getElementById('address').value);
  form.append('startLocation[description]', document.getElementById('startloc-description').value);
  form.append('startLocation[type]', 'Point');
  document.querySelectorAll('.form__group-location').forEach(function (el, i) {
    form.append("locations[".concat(i, "][type]"), 'Point');
    form.append("locations[".concat(i, "][coordinates][0]"), el.children[2].value);
...
if (deleteTourBtns) deleteTourBtns.forEach(function (btn) {
  btn.addEventListener('click', function (e) {
    e.preventDefault();
    var dialog = window.confirm('本当にこのツアーを削除しますか？');

    if (dialog) {
      var tourId = e.target.parentNode.parentNode.id;
...
if (selectBoxDifficultyEdit) {
  ...
  var val = selectBoxDifficultyEdit.dataset.difficulty;
  console.log(val);
...
if (editUserBtns) editUserBtns.forEach(function (btn) {
  btn.addEventListener('click', function (e) {
    e.preventDefault();
    var userId = e.target.parentNode.parentNode.id;
    var name = e.target.parentNode.parentNode.children[0].textContent;
    var email = e.target.parentNode.parentNode.children[1].textContent;
    var role = e.target.parentNode.parentNode.children[2].textContent; // query middlewareでactiveがfalseなdocumentは返ってこないので、すべてのdocumentのactiveはtrue
    // const active = e.target.parentNode.parentNode.children[3].textContent;

    var mailConfirm = e.target.parentNode.parentNode.children[4].textContent;
    ...
    if (!updateBtn) {
      ...
      var roleNum = roleOptions["".concat(role)];
      document.getElementById('role').options["".concat(roleNum)].selected = true;
      var mailConfirmOptions = {
        true: 0,
        false: 1
      };
...
var updateUserFunc = function updateUserFunc(e) {
  e.preventDefault();
  var userId = e.target.parentNode.parentNode.id;
  var form = new FormData();
  var elements = e.target.parentNode.parentNode.children;
...
if (deleteUserBtns) deleteUserBtns.forEach(function (btn) {
  btn.addEventListener('click', function (e) {
    e.preventDefault();
...
if (deleteReviewBtnsAtMyReviews) deleteReviewBtnsAtMyReviews.forEach(function (btn) {
  return btn.addEventListener('click', function (e) {
    e.preventDefault();
    console.log(e.target.parentNode.parentNode.dataset.reviewId);
    (0, _review.deleteReviewAtMyReviews)(e.target.parentNode.parentNode.dataset.reviewId);
  });
});
