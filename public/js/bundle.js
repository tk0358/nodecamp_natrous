...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"createReview.js":[function(require,module,exports) {
"use strict";
...
var editReviewBtns = document.querySelectorAll('.edit-review'); // DELEGATION
...
if (reviewForm) reviewForm.addEventListener('submit', function (e) {
  ...
  var tour = document.getElementById('review-user').dataset.tourId; // console.log(rating, review, user, tour);

  (0, _createReview.createReview)(rating, review, user, tour);
});
...
if (editReviewBtns) editReviewBtns.forEach(function (btn) {
