      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return (0, _axios.default)("/api/v1/bookings/checkout-session/".concat(tourId, "/").concat(startDate));
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'GET',
              url: "/api/v1/reviews?sort=".concat(field)
            });
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'GET',
              url: "/api/v1/bookings?sort=".concat(field)
            });
...
if (deleteDateBtn) deleteDateBtn.addEventListener('click', function (e) {
  e.preventDefault();
  var startDateGroups = document.getElementsByClassName('form__group-startDate');
  var formStartDates = document.getElementById('form__startDates');
